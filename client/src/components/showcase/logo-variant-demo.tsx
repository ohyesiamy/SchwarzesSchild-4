      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 p-8 flex flex-col items-center justify-center transition-all duration-300 hover:shadow-md">
          ...
          <div className="text-center">
            <h3 className="font-medium mb-2">Light Background</h3>
            <p className="text-sm text-gray-600">Black logo variant for optimal visibility on light backgrounds</p>
          </div>
        </div>
        ...
        <div className="bg-black border border-gray-800 p-8 flex flex-col items-center justify-center transition-all duration-300 hover:shadow-md">
          ...
          <div className="text-center text-white">
            <h3 className="font-medium mb-2">Dark Background</h3>
            <p className="text-sm text-gray-300">White logo variant for optimal visibility on dark backgrounds</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 p-8 flex flex-col items-center justify-center transition-all duration-300 hover:shadow-md">
          ...
          <div className="text-center">
            <h3 className="font-medium mb-2">Auto Selection (Light)</h3>
            <p className="text-sm text-gray-600">Logo automatically selects black variant on light background</p>
          </div>
        </div>
        ...
        <div className="bg-black border border-gray-800 p-8 flex flex-col items-center justify-center transition-all duration-300 hover:shadow-md">
          ...
          <div className="text-center text-white">
            <h3 className="font-medium mb-2">Auto Selection (Dark)</h3>
            <p className="text-sm text-gray-300">Logo automatically selects white variant on dark background</p>
          </div>
        </div>
      </div>
    </div>
